		...
		onTheWorklistPage : {
					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success : function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								id: oBindingContext.getProperty("Sicilno"),
								name: oBindingContext.getProperty("Adi")
							};
						}
					}));
				},
			...
			assertions: Object.assign({
				...
				theTableShouldHaveAllEntries : function () {
					...
					// retrieve all DogumGunleriBilgileriSet to be able to check for the total amount
					this.waitFor(this.createAWaitForAnEntitySet({
						entitySet: "DogumGunleriBilgileriSet",
