sap.ui.define([
	...
	return Opa5.extend("com.omerulucan.odataread.odataReadApp.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/omerulucan/odataread/odataReadApp/localService/mockserver"], function (mockserver) {
